...
start "" /min powershell -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command "Set-Location -LiteralPath $env:BAGO_UI_ROOT; python -m bago_core.launcher serve --port 8080"
