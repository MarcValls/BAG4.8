...
- UI runtime: `ui-react/dist` served by the local BAGO API server.
...
- `.github/workflows`: source repository concern. This runtime tree is not a Git repository and does not ship CI workflows.
