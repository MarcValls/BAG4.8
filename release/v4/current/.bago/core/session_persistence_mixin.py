...
class SessionPersistenceMixin:
    ...
    def _binding_state(self) -> dict[str, Any]:
        ...
        binding = resolve_workspace_binding(self.base_path)
        ...
        # scope, repo, and persisted expectations all agree.
        confirmed = bool(
            workspace_exists
        ...
        if not workspace_exists:
            ...
            reason = "repo missing"
        elif not repo_matches_workspace:
            reason = "workspace/repo mismatch"
